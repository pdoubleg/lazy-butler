...
export const DEFAULT_PROMPT_FILE = env.DEFAULT_PROMPT_FILE || "prompt_concierge.txt";
export const DEFAULT_TOPIC = env.DEFAULT_TOPIC || "Legal Services Department Inquiries";
